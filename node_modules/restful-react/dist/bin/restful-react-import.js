...
var generateRestfulComponent = function (operation, verb, route, operationIds, parameters, schemasComponents, customProps, skipReact, pathParametersEncodingMode, customGenerator) {
    ...
    if (!skipReact) {
        ...
        output += "export type Use" + componentName + "Props = Omit<Use" + Component + "Props<" + genericsTypesForHooksProps + ">, \"path\"" + (verb === "get" ? "" : " | \"verb\"") + ">" + (paramsInPath.length ? " & " + componentName + "PathParams" : "") + ";\n\n" + description + "export const use" + componentName + " = (" + (paramsInPath.length ? "{" + paramsInPath.join(", ") + ", ...props}" : "props") + ": Use" + componentName + "Props) => use" + Component + "<" + genericsTypes + ">(" + (verb === "get" ? "" : "\"" + verb.toUpperCase() + "\", ") + (paramsInPath.length
            ...
            : encode + "`" + route + "`") + ", " + (customPropsEntries.length || paramsInPath.length || verb === "delete"
            ? "{ " + (customPropsEntries.length
                ? customPropsEntries
                    ...
                    .join(", ") + ","
                : "") + (verb === "delete" && pathParametersEncodingMode ? "pathInlineBodyEncode: encodingFn, " : " ") + (paramsInPath.length ? "pathParams: { " + paramsInPath.join(", ") + " }," : "") + " ...props }"
            : "props") + ");\n\n";
    }
    // Custom version
    if (customGenerator) {

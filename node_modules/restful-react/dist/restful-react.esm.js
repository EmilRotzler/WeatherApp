...
var _fetchData = function _fetchData(props, state, setState, context, abort, getAbortSignal) {
  try {
    ...
    var url = constructUrl(base, pathStr, _extends({}, context.queryParams, {}, queryParams), {
  ...
  var mutate = useCallback(function (body, mutateRequestOptions) {
    try {
      ...
      if (body instanceof FormData) {
        ...
        var possiblyEncodedBody = props.pathInlineBodyEncode ? props.pathInlineBodyEncode(String(body)) : String(body);
